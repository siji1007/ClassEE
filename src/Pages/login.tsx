  ...
  {/* Login Card */}
    <div className="bg-gradient-to-br from-gray-300 via-gray-400 to-gray-500 bg-opacity-70 backdrop-blur-md p-10 rounded-xl shadow-lg text-center w-[350px] h-auto">
        ...
        <div className="flex justify-start">
            <p className="text-sm text-red-800 mt-2 cursor-pointer hover:underline">
            Forgot Password?
            </p>
        </div>
        ...
        <button
          onClick={handleLogin}
          className="cursor-pointer mt-6 w-full bg-red-800 hover:bg-red-700 text-white font-bold py-2 rounded-full shadow-md transition"
        >
          LOGIN
        </button>
        ...
        <button
          ...
          className="mt-4 w-full bg-white text-gray-700 border border-gray-300 hover:bg-gray-100 font-bold py-2 rounded-full shadow-md flex items-center justify-center space-x-2 transition"
        >
          <FaGoogle className="text-red-800" />
